  ...
  <el-main>
    <div class="main">
      <el-form
        ...
        class="demo-ruleForm"
      >
        <el-form-item label="参赛年度" prop="name">
          <el-col :span="14">
            <el-input size="small" v-model="awardForm.year"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="比赛名称" prop="name">
          <el-col :span="14">
            <el-input size="small" v-model="awardForm.name"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="获奖材料" prop="file">
          ...
          >
            ...
            <div slot="tip" class="el-upload__tip">只能上传doc或docx文件，且不超过5M</div>
          </el-upload>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" @click="submitForm('awardForm')" class="submit_style">发布获奖信息</el-button>
        </el-form-item>
      </el-form>
    </div>
...
<script>
import { awardInfoApi } from "../../request/api";
export default {
  data() {
    return {
      awardForm:{
