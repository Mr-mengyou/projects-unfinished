    ...
    <div class="main">
      ...
      >
        ...
        <el-form-item label="参赛对象" prop="crew">
          <el-select v-model="addActivForm.crew" placeholder="请选择参赛对象类别">
            <el-option
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('addActivForm')" class="submit_style">立即创建</el-button>
        </el-form-item>
      </el-form>
    </div>
  </el-main>
...
<script>
import { addActivityApi } from "../../request/api";
export default {
  data() {
    return {
      fileList: [],
  ...
  methods: {
    ...
    uploadSuccess(response, file, fileList) {
      ...
      if (response.code == 0) {
        ...
        // let opt = {
        //   method: "post",
        //   body: JSON.stringify(this.addActivForm),
        //   headers: {
